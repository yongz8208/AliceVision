...
int aliceVision_main(int argc, char** argv)
{
    ...
    const Matrix3x4 transform = (diag3x3(S, S, S) * rotationMatrix) | Point3d(t(0), t(1), t(2));

    ALICEVISION_LOG_INFO("Transform:");
    ALICEVISION_LOG_INFO("    " << transform.m11 << ", " << transform.m12 << ", " << transform.m13 << ", " << transform.m14);
    ALICEVISION_LOG_INFO("    " << transform.m21 << ", " << transform.m22 << ", " << transform.m23 << ", " << transform.m24);
    ALICEVISION_LOG_INFO("    " << transform.m31 << ", " << transform.m32 << ", " << transform.m33 << ", " << transform.m34);
